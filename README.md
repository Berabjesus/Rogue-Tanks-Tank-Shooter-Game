...
- When you die, you can restart the game or head back to the menu. Either way, your score, and name will be uploaded to the leaderboard API, and you will a `status - created 201` message on the gamover screen. 
