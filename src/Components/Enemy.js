...
export default class Enemy extends Phaser.GameObjects.PathFollower {
  ...
  rotateTurret() {
    let angel = Phaser.Math.Angle.Between(this.body.x, this.body.y, this.player.x, this.player.y);
  ...
  followPlayer() {
    ...
    let rotation = Phaser.Math.Angle.Between(this.x, this.y, this.player.x, this.player.y);
